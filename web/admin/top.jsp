                        ...
                        <tr>
                            ...
                            <td>
                                <div id="right_menu" class="menu">
                                    <ul>
                                        <li><a href="javascript:void(0)" target="_self" onclick="top.location.href='${contextPath}/admin/logout.do'"><span>退出重新登录</span></a></li>
                                        ...
                                        <li><a href="javascript:void(0)" target="_self" onclick="top.location.href='${contextPath}/admin/logout.do'"><span>退出</span></a></li>
                                    </ul>
                                </div>
                            </td>
                            <td width="18"></td>
